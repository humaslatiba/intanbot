    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        sock.ev.on('messages.upsert', (m) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!msg.key.fromMe && m.type === 'notify') {
                ...
                const pesanmasuk = (_b = (_a = msg.message) === null || _a === void 0 ? void 0 : _a.conversation) === null || _b === void 0 ? void 0 : _b.toLowerCase();
                ...
                //Bagian Layanan Integrasi
                    ...
                    const msgUsulan = yield sock.sendMessage(msg.key.remoteJid, { text: `*Info Integrasi* pada Lapas Narkotika Kelas IIB Banyuasin\n\n1. Pengusulan Pembebasan Bersyarat\n2. Pengusulan Asimiliasi\n3. Pengusulan Cuti Menjelang Bebas\n4. Pengusulan Cuti Bersyarat\n\n*Info Lengkap :*\nhttps://lpnbanyuasin.kemenkumham.go.id/` });
                    const msgUsulan1 = yield sock.sendMessage(msg.key.remoteJid, { text: `Sobat mau usulan hak integrasi untuk keluarga di dalam? 🤔\n\nSilahkan daftar data dulu yaa, Klik link dibawah ini👇\nhttps://bit.ly/LayananIntegrasiLATIBA` });
                    const msgUsulan2 = yield sock.sendMessage(msg.key.remoteJid, { text: `Jika sudah daftar, jangan lupa kirim pesan konfirmasi yaa 🤔\n\n Contoh : konfirmasi usulan` });
                }
                ...
                //bagian konfirmasi usulan
                    ...
                    axios_1.default.get(`https://script.google.com/macros/s/AKfycbz866hCzZu2rak3XP9SYlvGNBxwdj2K8GBPtL0KSKPmIjPfL3j0SKHRfSa6sHJISEg/exec?whatsapp=` + ((_c = msg.key.remoteJid) === null || _c === void 0 ? void 0 : _c.replace('@s.whatsapp.net', '')))
                        ...
                        if (success) {
                            ...
                            const msgUsulanPenjamin = yield sock.sendMessage(msg.key.remoteJid, {
                                text: str
                            });
                            ...
                            const msgUsulanAdmin = yield sock.sendMessage(admin, {
                                text: stradmin
                            });
                        }
                        else {
                            strbelum = `*Hai Sobat LATIBA*, sepertinya kakak belum daftar usulan yaa 😊\n\nSilahkan daftar data dulu yaa, Klik link dibawah ini👇\nhttps://bit.ly/LayananIntegrasiLATIBA`;
                            const belumusulan = yield sock.sendMessage(msg.key.remoteJid, {
                                text: strbelum
                            });
                        }
                    }));
                ...
                //Bagian Layanan Aduan
                    ...
                    const msgAduan = yield sock.sendMessage(msg.key.remoteJid, { text: `Intan Infoin yaa 😊` });
                    const msgAduan1 = yield sock.sendMessage(msg.key.remoteJid, { text: `Apabila dalam pelayanan kami tidak sesuai pada SOP yang berlaku, Bapak/ibu bisa melaporkan hal tersebut dengan cara sebagai berikut:\n\n1. Memberikan saran pada kotak aduan yang ada di lapas\n2. Menghubungi Nomor Pengaduan 💬 +62895327189334\n3. Mengisi informasi aduan pada link berikut bit.ly/LayananPengaduanLATIBA\n\n*Data Dijamin Kerahasiaannya*` });
                }
                //Bagian Jam
                else if (nises.includes('5') || nises.includes('jam') || nises.includes('waktu')) {
                    const msgJam = yield sock.sendMessage(msg.key.remoteJid, { text: `Oke Sobat 😉` });
                    const msgJam1 = yield sock.sendMessage(msg.key.remoteJid, { text: `Mulai  tanggal 23 Maret 2023, Waktu layanan di Lapas Narkotika Kelas IIB Banyuasin mulai dari 09:00 - 15:00 WIB.\n\n*Waktu Kunjungan*\nSenin-Kamis\nPagi : 09:00-11:30 WIB\nSiang : 13:00-14:30 WIB\n\n*Waktu Penitipan Barang*\nSenin-Kamis\nPagi : 09:00-11:30 WIB\nSiang : 13:00-14:30 WIB\n\nJum'at-Sabtu\nPagi : 09:00-11:30 WIB\n\n*Info Lengkap:*\nhttps://lpnbanyuasin.kemenkumham.go.id/` });
                }
                //Bagian Lokasi
                else if (nises.includes('6') || nises.includes('lokasi')) {
                    const msgLokasi = yield sock.sendMessage(msg.key.remoteJid, { text: `Oke Sobat` });
                    const msgLokasi1 = yield sock.sendMessage(msg.key.remoteJid, { text: `Untuk mengetahui lokasi Lapas Narkotika Kelas IIB Banyuasin, silahkan kunjungi lokasi berikut melalui google maps 🌎\n\n*Klik link dibawah yaa* 👇\nhttps://goo.gl/maps/CscbeP3ppPJTLn3p8` });
                }
                else {
                    const sentMsg = yield sock.sendMessage(msg.key.remoteJid, { text: '*Sobat LATIBA*\n\nMaaf yaa, Intan belum mengerti apa yang sobat maksud. Silahkan tanyakan langsung keperluan sobat ke petugas kami 😉\n\n💬 Tanya Langsung CS Kami +62895327189334' });
                }
            }
        }));
    });
